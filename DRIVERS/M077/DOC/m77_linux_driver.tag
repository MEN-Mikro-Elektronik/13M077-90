...
<tagfile>
  <compound kind="page">
    ...
    <title>Linux native driver for quad and octal UART M-Modules.</title>
    <name>index</name>
  </compound>
  <compound kind="file">
  ...
  <compound kind="file">
    <name>serial_m77.h</name>
    <path>/opt/menlinux/DRIVERS/M077/DRIVER/</path>
    <filename>serial__m77_8h</filename>
  </compound>
  <compound kind="file">
    <name>serial_m77_doc.c</name>
    <path>/opt/menlinux/DRIVERS/M077/DRIVER/</path>
    <filename>serial__m77__doc_8c</filename>
  </compound>
  ...
  <compound kind="struct">
    <name>men_uart_config</name>
    <filename>structmen__uart__config.html</filename>
  </compound>
  <compound kind="struct">
    <name>ox16c954_port</name>
    <filename>structox16c954__port.html</filename>
  </compound>
  <compound kind="struct">
    <name>plat_men_uart_port</name>
    <filename>structplat__men__uart__port.html</filename>
  </compound>
  <compound kind="struct">
    <name>uartmod</name>
    <filename>structuartmod.html</filename>
  </compound>
  <compound kind="page">
    <name>m77dummy</name>
    <title>MEN logo</title>
    <filename>m77dummy</filename>
  </compound>
  <compound kind="group">
